...
print("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXxY")
...
'''
print("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXxYYYYYYYYYYYYYYYYYYYYYYY")
energy = energyfunction(maze, start_state, goal_state)
print(energy >= HILLDESCENT(maze, start_state, goal_state, 100)[1])
print(energy >= HILLDESCENT_RANDOM_RESTART(
    maze, start_state, goal_state, 100, 5)[1])
print(energy >= HILLDESCENT_RANDOM_UPHILL(
    maze, start_state, goal_state, 100, 0.03)[1])
print(energy >= SIMULATED_ANNEALING(
    maze, start_state, goal_state, 100, 1000, 0.98)[1])
